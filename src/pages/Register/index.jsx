    ...
    <div className="wrapper">
      <form className="form-wrap" noValidate onSubmit={onSubmit}>
        ...
        <div className="sub-title-signup">
          Học tập và giao lưu với hàng triệu học
        ...
        <div className="wrap-input">
          <div className="error-mess  error-mess-pass">
        ...
        <div className="se-box-note">
          ...
          <a href="https://hocmai.vn/privacy2.php">
            Chính sách bảo mật, Điều khoản dịch vụ và chính sách tư vấn
          </a>
          của HOCMAI.
        </div>
        <button
