   ...
   const status = handleStatus(data.trangThai)
    ...
    <h4 className="nameChapter custom-show">{data.tenBaiHoc}</h4>
      ...
      <ul className="list-inline mb-0">
              ...
              <a href={`/edit-lesson/${data.id}`} className="px-2 text-primary"><FontAwesomeIcon icon={faPencil} fontSize={18}/></a>
              </li>
              <li className="list-inline-item">
              <button  className="px-2 text-danger bg-transparent"><FontAwesomeIcon icon={faTrash} fontSize={18}/></button>
              </li>
      </ul>
  </div>
}
